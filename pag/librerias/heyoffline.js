...
// ANALIZA Y ALERTA SI UN USUARIO SE DESCONECTA DE INTERNET
Heyoffline = (function() {
  ...
  Heyoffline.prototype.options = {
    text: {
      title: "Actualmente se encuentra desconectado de Internet",
      content: "Parece que se ha desconectado de internet, es posible que desee esperar hasta que su red se recupere antes de continuar. <br><br><b>Este curso solo se vera afectado a nivel de los Banner de Publicidad que usted vera en el cintillo superior</b> <br><br> Este mensaje se autodestruirá una vez que esté en línea de nuevo. ",
      button: "Continuar Desconectado de Internet"
    },
    monitorFields: false,
    prefix: 'heyoffline',
    noStyles: false,
